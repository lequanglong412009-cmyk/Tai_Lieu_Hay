      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-slate-400 text-xs leading-relaxed font-bold max-w-xs">
              Nền tảng chia sẻ học liệu và ôn thi THPT Quốc gia hàng đầu Việt
              Nam. Đồng hành cùng sĩ tử chinh phục ước mơ đại học.
            </p>
            <div className="flex items-center gap-3">
              {[
                ...
                { icon: Send, color: "hover:bg-sky-500", path: "#" },
                {
                  ...
                  path: "https://Zalo.me/0386281920",
                },
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.path}
                  className={`w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center ${social.color} hover:text-white transition-all text-slate-500 border border-white/5`}
                >
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.name}>
                    <Link
                      to={link.path}
                      className="text-slate-400 hover:text-white transition-colors text-xs font-bold flex items-center gap-2 group"
                    >
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              <a
                href="mailto:tailieuhay53@gmail.com"
                className="flex items-center gap-3 bg-white/5 hover:bg-white/10 transition-all p-3 rounded-xl border border-white/5 group relative overflow-hidden"
              >
                ...
                <div className="flex flex-col min-w-0 pr-8">
                  ...
                  <span className="text-xs font-bold text-white truncate">
                    tailieuhay53@gmail.com
                  </span>
                </div>
                <button
                  onClick={(e) =>
                    handleCopy(e, "tailieuhay53@gmail.com", "email")
                  }
        ...
        <div className="pt-4 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-2 text-center md:text-left">
          ...
          <div className="flex items-center gap-1 px-3 py-1 bg-white/5 rounded-full border border-white/5 text-slate-400 text-[10px] font-black uppercase tracking-widest">
            <ShieldCheck className="w-3 h-3 text-emerald-500" /> Bảo mật & Bảo
            vệ
          </div>
        </div>
      </div>
